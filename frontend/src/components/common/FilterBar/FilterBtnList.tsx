...
const FilterBtnList = ({
  ...
  return (
    <FilterBtnContainer>
      <FilterBtn
        state={filterBtnState[0]}
        onClick={() => onclick(0, filterBtnState, setFilterBtnState)}
      >
        <Span state={filterBtnState[0]}>영상만 보기</Span>
      </FilterBtn>
      <FilterBtn
        state={filterBtnState[1]}
        onClick={() => onclick(1, filterBtnState, setFilterBtnState)}
      >
